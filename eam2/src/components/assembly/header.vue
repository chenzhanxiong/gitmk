<template>
	<div class="header-box">
		...
		<header v-if="$store.state.heads.show == true">
			<div class="header-page" v-for="(list,i) in mes" v-if="list.show">
				...
				<input v-if="i == 1 && list.input" v-model="list.html" type="text"><i v-if="i == 1 && list.input" @click="listevent(list)" class="iconfont icon-sousuo"></i>
			</div>
		</header>
